...
const OccupationList = ({
  ...
  return (
    <div>
      ...
      <select
        className={`border-gray-400 border rounded-md form-control dropdown py-3 px-4 block w-full text-blackrounded-md text-sm focus:border-green-500 focus:ring-green-500 bg-white`}
        id={item.display}
        name={item.display}
