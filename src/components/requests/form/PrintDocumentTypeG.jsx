...
const PrintDocumentTypeG = ({
    ...
    const getOrdinalSuffix = (day) => {
      ...
      const formattedDate = `${day}${ordinalSuffix} day of ${date.toLocaleDateString("en-PH", {
        month: "long",
        year: "numeric",
    })}`;
    ...
    const Title = () => (
        <View style={styles.title.view1}>
            <Text style={styles.title.req}>Certificate of Indigency</Text>
        </View>
    );
            ...
            <View style={{ marginLeft: 10, marginRight: 10 }}>
                ...
                >
                    <View style={styles.terms.half}>
                        ...
                        <Text style={{ fontFamily: "Times-Italic", fontSize: 12, marginBottom: 10 }}>Certified by :</Text>
...
export default PrintDocumentTypeG;
