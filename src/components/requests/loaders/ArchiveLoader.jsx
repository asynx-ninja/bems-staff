...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the service request, Please wait...",
    waiting: "Please wait...",
    success: "Service Request Archive Successfully!",
    error: "Error archiving service request. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the service request.."
  );
