...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the service request, Please wait...",
    waiting: "Please wait...",
    success: "Service Request Restored Successfully!",
    error: "Error restoring service request. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the service request.."
  );
