...
function ReplyLoader({ replyingStatus, error }) {
  const textPrompts = {
    replying: "Replying to the service request...",
    waiting: "Please wait...",
    success: "Service Request Reply Sent!",
    error: "Error replyign to service request. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[replyingStatus] || "Replying to the service request..."
  );
