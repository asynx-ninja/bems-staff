...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the event application, Please wait...",
    waiting: "Please wait...",
    success: "Event Application Restored Successfully!",
    error: "Error restoring event application. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the event application.."
  );
