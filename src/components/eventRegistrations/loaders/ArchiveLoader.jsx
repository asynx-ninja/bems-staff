...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the event application, Please wait...",
    waiting: "Please wait...",
    success: "Event Application Archived Successfully!",
    error: "Error archiving event application. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the event application.."
  );
