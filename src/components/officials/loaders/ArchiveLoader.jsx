...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the barangay official, Please wait...",
    waiting: "Please wait...",
    success: "Barangay Official Archived Successfully!",
    error: "Error archiving barangay official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the barangay official.."
  );
