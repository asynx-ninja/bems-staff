...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the barangay official, Please wait...",
    waiting: "Please wait...",
    success: "Barangay Official Restored Successfully!",
    error: "Error restoring barangay official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the barangay official.."
  );
