    ...
    <nav className="flex ">
      <ol className="flex items-center space-x-2 text-gray-500 mt-[-1rem]">
        ...
        <Link
          ...
          {/* <a href={`/blotters/?id=${id}&brgy=${brgy}`} className="text-gray-600 font-bold hover:underline text-sm md:text-lg">
            BLOTTERS
          </a> */}
        </li>
        <li>
        ...
        <li className="text-sm md:text-lg text-[#295141] font-bold">ARCHIVED BLOTTERS</li>
      </ol>
    </nav>
  );
};
