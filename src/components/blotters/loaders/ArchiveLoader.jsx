...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the patawag (blotter), Please wait...",
    waiting: "Please wait...",
    success: "Patawag (Blotter) Archive Successfully!",
    error: "Error archiving patawag (blotter). Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the patawag (blotter).."
  );
