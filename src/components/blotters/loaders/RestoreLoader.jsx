...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the patawag (blotter), Please wait...",
    waiting: "Please wait...",
    success: "Patawag (Blotter) Restored Successfully!",
    error: "Error restoring patawag (blotter). Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the patawag (blotter).."
  );
