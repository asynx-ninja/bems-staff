...
function RestoreRequestsModal({ selectedItems, socket, id }) {
    ...
    try {
      ...
      for (let i = 0; i < selectedItems.length; i++) {
        ...
        if (response.status === 200) {
          ...
          const logsData = {
            action: "Restored",
            details: `Restored a patawag (blotter) with the (ID: ${selectedItems[i]})`,
            ip: ip,
          };
...
export default RestoreRequestsModal;
