...
const PrintPatawag = ({
  ...
  const filipinoDate = blotter?.date
    ? new Date(blotter.date)
        ...
        .replace(
          new Date(blotter.date).toLocaleDateString("en-PH", { month: "long" }),
          monthsFilipino[new Date(blotter.date).getMonth()]
        )
    : "";
    ...
    <View>
      ...
      >
        ...
        >
          ...
          >
            Usapin ng Barangay Blg: {blotter?.usapin_blg}
          </Text>
          <Text
            style={{
              fontSize: 12,
