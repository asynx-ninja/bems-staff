...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating the resident information...",
    waiting: "Please wait...",
    success: "Resident Update Successful!",
    error: "Error updating resident. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating the resident information.."
  );
  ...
  return (
    <div className="absolute bottom-0 lg:bottom-0 lg:end-0 mb-20 lg:mr-10 z-[80] just">
