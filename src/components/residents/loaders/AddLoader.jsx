...
function AddLoader({ creationStatus, error }) {
  const textPrompts = {
    creating: "Creating the new resident...",
    waiting: "Please wait...",
    success: "Resident Creation Successful!",
    error: "Error creating resident. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[creationStatus] || "Creating the new resident.."
  );
