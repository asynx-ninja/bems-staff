...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the barangay staff, Please wait...",
    waiting: "Please wait...",
    success: "Barangay Staff Archived Successfully!",
    error: "Error archiving barangay staff. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the barangay staff.."
  );
