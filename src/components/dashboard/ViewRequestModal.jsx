...
import PersonalDetails from "../requests/PersonalDetails";
import OtherDetails from "../requests/OtherDetails";
import PrintPDF from "../requests/form/PrintPDF";
import { Link } from "react-router-dom";

function ViewRequestModal({ request, id, brgy}) {
