...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating the barangay info...",
    waiting: "Please wait...",
    success: "Barangay Info Update Successful!",
    error: "Error updating barangay info. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating the barangay info..."
  );
