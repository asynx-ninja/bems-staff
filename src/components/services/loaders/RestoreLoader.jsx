...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the barangay service, Please wait...",
    waiting: "Please wait...",
    success: "Barangay Service Restored Successfully!",
    error: "Error restoring barangay service. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the barangay service.."
  );
