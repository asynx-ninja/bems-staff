...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving the barangay service, Please wait...",
    waiting: "Please wait...",
    success: "Barangay Service Archive Successfully!",
    error: "Error archiving barangay service. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving the barangay service.."
  );
