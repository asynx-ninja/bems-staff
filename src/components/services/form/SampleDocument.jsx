  ...
  const LetterHead = () => (
    <View style={styles.letterHead.view1}>
      ...
      <View style={styles.letterHead.view2}>
        ...
        <Text style={styles.letterHead.brgy}>BARANGAY BALITE</Text>
              ...
              ([key, value], idx) => {
                return value.display !== "address" ? (
                  <View key={idx} style={styles.info.tableCell}>
                    ...
                    <Text style={styles.info.value}>DELOS SANTOS</Text>
                  </View>
                ) : (
                  <View
                    key={idx}
                  ...
                  >
                    ...
                    <Text style={styles.info.value}>
                      DELOS SANTOS DELOS SANTOS DELOS SANTOS
                    </Text>
                  </View>
                );
              }
            ...
            <View style={styles.info.table}>
              {item.form.map((form, idx) => (
                ...
                >
                  ...
                  <Text style={styles.info.value}>DELA CRUZ</Text>
                </View>
              ))}
            </View>
          </View>
