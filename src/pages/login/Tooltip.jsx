...
const Tooltip = () => {
    ...
    return (
        ...
        <div>
            ...
            <div>
                {/* Back icon */}
                <Link to="/" className="absolute top-4 left-4 text-white bg-custom-green-header p-1 rounded-full z-40">
                    <svg
                        ...
                        >
                            ...
                            <div className="w-full md:w-full lg:w-1/2 sm:p-0 md:p-6 order-1 md:order-2">
                                <h1 className="sm:text-[24px] md:text-4xl sm:leading-6 md:leading-none font-bold text-gray-900 mb-4 sm:text-center lg:text-left">
                                    Introducing <b className='text-custom-green-header'>Bagong Montalban</b> Barangay App
                                </h1>
