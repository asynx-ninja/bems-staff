                      ...
                      <span className="text-xs sm:text-sm text-black line-clamp-2">
                        <div className="py-2 xl:px-6 xl:py-2">
                          <img
                            ...
                            alt=""
                            className="w-[70px] h-[70px] md:w-[80px] md:h-[80px] xl:h-28 xl:w-28 bg-cover rounded-full mx-auto border-[5px] object-cover" style={{ borderColor: information?.theme?.primary }}
                          />
                        </div>
                      </span>
                    </td>
