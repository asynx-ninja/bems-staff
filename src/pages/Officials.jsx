    ...
    <div className="mx-4 my-5 md:mx-5 md:my-6 lg:ml-[19rem] lg:mt-8 lg:mr-6">
      ...
      <div>
        ...
        <div className="flex flex-col-reverse lg:flex-row mt-5">
          {/* Table Title */}
          <div className="bg-[#295141] py-2 lg:py-3.5 xxl:py-5 px-5 md:px-10 lg:px-10 xxl:px-4 rounded-tr-lg w-full lg:w-3/5">
            <h1
        ...
        {/* Table */}
        <div className="overflow-x-auto lg:h-[680px] xl:h-[700px] xxl:h-[690px] xxxl:h-[640px] border">
                ...
                .map((_, idx) => (
                  <tr className="bg-white hover-bg-gray-50 border">
                    ...
                    <td className="w-[20%] sm:w-1/5 whitespace-nowrap border">
                      ...
                      <img src={officialimage} alt="" className="w-32 mx-auto rounded-full" />
                      </div>
                    </td>
