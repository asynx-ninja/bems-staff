            ...
            <div className="hs-dropdown relative inline-flex sm:[--placement:bottom] md:[--placement:bottom-left]">
              ...
              >
                <li
                  ...
                  className={`font-medium uppercase flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#0d4b75] to-[#2645a6] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500 ${statusFilter === "all" && "bg-gradient-to-r from-[#0d4b75] to-[#2645a6]"
                    }`}
                >
                  ALL
                </li>
                <li
                  ...
                  className={`font-medium uppercase flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#0d4b75] to-[#2645a6] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500 ${statusFilter === "Registered" && "bg-gradient-to-r from-[#0d4b75] to-[#2645a6]"
                    }`}
                >
                  REGISTERED
                </li>
                <li
                  ...
                  className={`font-medium uppercase flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#0d4b75] to-[#2645a6] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500 ${statusFilter === "Pending" && "bg-gradient-to-r from-[#0d4b75] to-[#2645a6]"
                    }`}
                >
                  PENDING
                </li>
                <li
                  ...
                  className={`font-medium uppercase flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#0d4b75] to-[#2645a6] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500 ${statusFilter === "Denied" && "bg-gradient-to-r from-[#0d4b75] to-[#2645a6]"
                    }`}
                >
                  DENIED
                </li>
