...
import AddStaffModal from "../components/brgyAdmin/AddStaffModal";
import ManageStaffModal from "../components/brgyAdmin/ManageStaffModal";
import ArchiveStaffModal from "../components/brgyAdmin/ArchiveStaffModal";

const BrgyAdminManagement = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const response = await axios.get(
        `${API_LINK}/users/?brgy=${brgy}&type=Brgy Admin&page=${currentPage}`
      );
          ...
          <div className="lg:w-3/5 flex flex-row justify-end items-center ">
            <div className="sm:w-full md:w-full lg:w-2/5 flex sm:flex-col md:flex-row md:justify-center md:items-center sm:space-y-2 md:space-y-0 md:space-x-2 ">
              ...
              <div className="w-full rounded-lg ">
                <Link to={`/archived_brgy_admin_management/?id=${id}&brgy=${brgy}`}>
                  <div className="hs-tooltip inline-block w-full">
                    <button
                      type="button"
                ...
                <div className="hs-tooltip inline-block w-full">
                  ...
                  >
                    ...
                    <span
                      ...
                      role="tooltip"
                    >
                      Archive Selected Barangay Admins
                    </span>
                  </button>
                </div>
              </div>
...
export default BrgyAdminManagement;
