      ...
      <div className="flex flex-col ">
        ...
        <div className="scrollbarWidth scrollbarTrack scrollbarHover scrollbarThumb overflow-y-scroll lg:overflow-x-hidden h-[calc(100vh_-_275px)] xxl:h-[calc(100vh_-_275px)] xxxl:h-[calc(100vh_-_300px)]">
          ...
          <table className="divide-y table-auto w-full rounded-lg border border-gray-300 shadow-lg overflow-hidden">
            <thead
              className="bg-gray-900 sticky top-0"
              style={{ backgroundColor: information?.theme?.primary }}
            >
              <tr>
                {tableHeader.map((item, idx) => (
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredlogs.length === 0 ? (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <img
                        src={noData}
                        alt="No Data"
                        className="w-24 h-24 md:w-36 md:h-36 lg:w-48 lg:h-48 xl:w-60 xl:h-60 mx-auto"
                      />
                      <strong className="text-gray-500 mt-4">
                        NO DATA FOUND
                      </strong>
                    </div>
                  </td>
                ...
                filteredlogs.map((item, index) => (
                  <tr
                    key={index}
                    className="cursor-pointer transition duration-300 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-700"
                    onClick={() => handleRowClick(item)}
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                      <div className="flex items-center">
                        <span
                          className={`inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium mr-2 
                                ${
                                  item.action === "Created"
